  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        "Configurei e gerenciou pfSense com VPNs seguras e firewall customizado, aumentando a segurança e reduzindo falhas de acesso remoto.",
      ],
      technologies: [
        "PowerShell",
        "Windows Server",
    ...
    },
    {
      ...
      description: [
        ...
        "Integração de testes de APIs com Postman.",
        "Gestão de tarefas em Bitrix24 e participação em cerimônias ágeis",
      ],

      achievements: [
        "Desenvolvi e manteve aplicações web escaláveis em PHP (Laravel e Zend Framework 2), garantindo maior estabilidade e redução de falhas em produção",
    ...
    },
    {
      ...
      description: [
        ...
        "Driação de interfaces com HTML5, CSS3, JavaScript, jQuery e integração com bancos de dados MySQL.",
        "Versionamento de código com Git/GitHub.",
        "Apoio a clientes e suporte técnico em sistemas web",
        "Aplicação de práticas de Clean Code e arquitetura MVC.",
      ],
      achievements: [
        "Desenvolvi e implantou portais oficiais para Câmaras Municipais e Prefeituras, garantindo conformidade com normas de transparência pública e acessibilidade.",
        "Otimização de desempenho dos sites institucionais, resultando em carregamento até 60% mais rápido e melhor experiência do cidadão.",
